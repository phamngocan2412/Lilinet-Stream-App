            ...
            return BlocBuilder<FavoritesBloc, FavoritesState>(
              builder: (context, state) {
                ...
                if (state is FavoritesLoaded) {
                  ...
                  // Optimization: Memoize folders and filtered favorites to prevent
                  // O(N log N) sorting and mapping on every frame rebuild.
                  if (_cachedFavorites != state.favorites ||
                      _cachedSelectedFolder != _selectedFolder) {
