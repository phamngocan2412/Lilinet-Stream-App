...
class _FavoritesViewState extends State<FavoritesView> {
  ...
  // Memoization cache for derived collections
            ...
            return BlocBuilder<FavoritesBloc, FavoritesState>(
              builder: (context, state) {
                ...
                if (state is FavoritesLoaded) {
                  ...
                  // Optimization: Memoize O(N log N) folder extraction and O(N) filtering
                  // to prevent unnecessary recalculation during tab switches or unrelated re-renders.
