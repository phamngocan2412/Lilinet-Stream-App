...
import '../bloc/video_player_state.dart'; // Corrected path
import '../../../settings/domain/entities/app_settings.dart'; // Corrected path
        ...
        return ListView(
          ...
          children: [
            ...
            if (streamingState is StreamingLoaded &&
              ...
              Builder(
                builder: (context) {
                  // Map Quality -> Link Object to preserve headers
